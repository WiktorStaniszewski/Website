...
import Parallax from 'src/components/functions/Parralax/Parallax';
    ...
    return (
        <>
            <section className="flex justify-center flex-col w-screen">
                <div className='h-[60vh] flex flex-col items-center justify-center text-center mb-10 gap-8'>
            ...
            <section className="flex justify-center items-center w-screen flex-col py-20 lg:py-10 backdrop-brightness-85">
                <div className='flex justify-center items-center w-screen lg:w-7/10 lg:h-8/10 flex-col'
                        onMouseEnter={() => setIsHovered(true)}
                        onMouseLeave={() => setIsHovered(false)}>
                    <img src="images/Somnium/Somnium-Wide.jpg" alt="cup" className={`lg:rounded-3xl transition-all duration-300 ease-in-out ${isHovered ? 'blur-sm' : ''}`} 
                    />
                    <div className={`absolute w-6/10 items-center justify-center flex-col text-center text-(--font-color) transition-all duration-300 gap-8 ease-in-out ' ${isHovered ? 'flex' : 'hidden'}`}
                    >
                        <h1 className='text-5xl font-bold'>Czemu Body?</h1>
            ...
            <section className="flex justify-center items-center w-screen flex-col">
                <div className='h-[60vh] flex items-center justify-center flex-col w-7/10 text-center gap-8'>
            ...
            <div className='flex justify-center items-center w-screen flex-col py-10 h-8/10 backdrop-brightness-85'>
                <img src="images/coffeebeans.jpg" alt="" className='rounded-3xl'/>
            </div>
            <section className='w-screen flex justify-center items-center flex-col py-10 h-[60vh]'>
