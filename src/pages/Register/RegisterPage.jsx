...
export default function RegisterPage() {
  return (
    <div className="min-h-screen w-full flex items-center justify-center pt-24 pb-12 relative overflow-hidden">
      ...
      <div 
        className="absolute top-1/4 -left-20 w-[400px] h-[400px] rounded-full animate-pulse pointer-events-none"
        style={{ background: 'radial-gradient(circle, var(--medium-shade) 0%, transparent 60%)', opacity: 0.2 }}
      ></div>
      <div 
        className="absolute bottom-1/4 -right-20 w-[400px] h-[400px] rounded-full animate-pulse pointer-events-none" 
        style={{ background: 'radial-gradient(circle, #5C4A3D 0%, transparent 60%)', opacity: 0.3, animationDelay: '2s' }}
      ></div>
