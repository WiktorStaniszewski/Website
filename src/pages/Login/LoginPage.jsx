...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center pt-24 pb-12 relative overflow-hidden">
      ...
      <div 
        className="absolute top-1/3 -right-20 w-[400px] h-[400px] rounded-full animate-pulse pointer-events-none"
        style={{ background: 'radial-gradient(circle, var(--medium-shade) 0%, transparent 60%)', opacity: 0.2 }}
      ></div>
      <div 
        className="absolute bottom-1/3 -left-20 w-[400px] h-[400px] rounded-full animate-pulse pointer-events-none" 
        style={{ background: 'radial-gradient(circle, #5C4A3D 0%, transparent 60%)', opacity: 0.3, animationDelay: '1.5s' }}
      ></div>

      <div className="relative w-full max-w-md z-10 px-4">
        <div className="bg-[#24201d]/60 backdrop-blur-md p-8 sm:p-10 rounded-[2.5rem] shadow-[0_20px_60px_rgba(0,0,0,0.4)] border border-white/10 animate-in fade-in zoom-in-95 duration-700 ease-out relative overflow-hidden">
