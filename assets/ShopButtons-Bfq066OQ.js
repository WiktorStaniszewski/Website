import{B as A,r as f,j as e,q as g,P as h,Q as j,S as p}from"./index-4IC1JREA.js";const v=({product:s,compact:w=!1,className:l=""})=>{const{addToCart:y,cartItems:C}=A(),[n,c]=f.useState(!1),[o,m]=f.useState(!1),x=C.find(d=>d.id===(s.id||s.name)),k=x?x.quantity:0,u=s.stockQuantity||0,t=u<=0,a=k>=u,r=t||a||o,b=async d=>{if(d.stopPropagation(),r)return;m(!0);const N={id:s.id||s.name,title:s.name,price:Number(s.price),img:s.image||s.img,...s},z=await y(N);m(!1),z&&(c(!0),setTimeout(()=>c(!1),1500))};let i="Dodaj do koszyka";return o?i="Dodawanie...":t?i="Wyprzedane":a?i="Max. ilość w koszyku":n&&(i="Dodano!"),w?e.jsx("button",{onClick:b,disabled:r,className:`
